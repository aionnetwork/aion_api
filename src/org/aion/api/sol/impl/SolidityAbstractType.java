    ...
    private Object decodeHelper(int offset, ByteArrayWrapper data, int layer) {
        ...
        if (this.getLayerIsDynamicArray(layer)) {
            ...
            int roundedNestedStaticPartLength =
                ((int) (((double) nestedStaticPartLength + encodeUnitLength - 1)
                    / encodeUnitLength)) * encodeUnitLength;

            List ret = new ArrayList();

            for (int i = 0; i < length * roundedNestedStaticPartLength;
            ...
            int roundedNestedStaticPartLength =
                ((int) (((double) nestedStaticPartLength + encodeLen - 1) / encodeLen)) * encodeLen;
