...
public final class TxDetails {
    ...
    private final NewAddress contract;
    ...
    public static class TxDetailsBuilder {
        ...
        public TxDetailsBuilder from(final NewAddress from) {
            this.from = from;
            return this;
        }

        public TxDetailsBuilder to(final NewAddress to) {
            this.to = to;
            return this;
        }
        ...
        public TxDetailsBuilder contract(final NewAddress contract) {
