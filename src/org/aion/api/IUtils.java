...
public interface IUtils {
    /**
     * It is a help function to convert a byte array to it's hex representation as string.
     * Returns hex string given a valid byte array.
     *
     * @param bytes
     *         the variable bytes array.
     * @return the class {@link java.lang.String String}.
     */
    static String bytes2Hex(byte[] bytes) {
        if (bytes == null) {
            System.err.println(new Throwable().getStackTrace()[0].getMethodName() + ErrId.getErrString(-313L));
            return null;
        }
     ...
     *
     * @param hexstr
     *         the class {@link java.lang.String String} of the bytes.
     * @return the variable bytes array represented of the hex string.
     */
    static byte[] hex2Bytes(String hexstr) {
        if (hexstr == null) {
            System.err.println(new Throwable().getStackTrace()[0].getMethodName() + ErrId.getErrString(-314L));
            return null;
        }
     ...
     *
     * @param status
     *         the int value represent the transaction status is the end status.
     ...
     *
     * @param in
     *         the bytes array want to do sha3 hashing.
