...
public interface ITx {
     ...
     *
     * @param address the class {@link NewAddress Address} represent the deployed contract address.
     ...
     */
    ApiMsg getCode(NewAddress address);
     ...
     *     through {@link ApiMsg#getObject() getObject}.
     */
    ApiMsg getCode(NewAddress address, long blockNumber);
     ...
     */
    ApiMsg eventDeregister(List<String> evt, NewAddress address);
     ...
     * @return the boolean value represent the register success or failed.
     */
    ApiMsg eventRegister(List<String> evt, ContractEventFilter ef, NewAddress address);
