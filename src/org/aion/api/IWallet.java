...
public interface IWallet {
     ...
     *
     * @param acc the class {@link NewAddress Address} represent the account address.
     ...
     */
    ApiMsg unlockAccount(NewAddress acc, String passphrase);
     ...
     */
    ApiMsg unlockAccount(NewAddress acc, String passphrase, int duration);

    /**
     * Returns the default miner account of the backend. miner account refers to the address
     * utilized when isMining.
     *
     * @return the class {@link NewAddress Address} represent the miner's account address of the
     ...
     */
    ApiMsg setDefaultAccount(NewAddress acc);

    /**
     * Returns the default account of the user latest set.
     *
     * @return the class {@link NewAddress Address} represent the default account of the user latest
     ...
     *     through this method {@link ApiMsg#getObject() getObject}.
     */
    ApiMsg lockAccount(NewAddress acc, String passphrase);
}
