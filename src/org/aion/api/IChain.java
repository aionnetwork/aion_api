...
/**
 * This interface provides methods for fetching blockchain specific details such as blocks and transactions.
 * @author Jay Tseng
 */
...
public interface IChain {
     ...
     *
     * @return The current block number by long value wrapped into ApiMsg.
     * You can retrieve through the method {@link ApiMsg#getObject() getObject}.
     */
    ApiMsg blockNumber();

    /**
     * GetBalance returns a BigInteger representing the balance of the account
     * address at latest block number.
     *
     * @param address
     *         the class {@link Address Address} of the desired account to get the balance of.
     *
     * @return balance of the desired account by the class {@link BigInteger BigInteger} wrapped into ApiMsg.
     * You can retrieve through the method {@link ApiMsg#getObject() getObject}.
     */
    ApiMsg getBalance(Address address);

    /**
     * GetBalance returns a Long value representing the balance of the account
     * address at a certain block number.
     *
     * @param address
     *         the class {@link Address Address} of the desired account.
     *
     * @param blockNumber
     *         the block number by long value at which the balance of the address
     ...
     *
     * @param blockNumber
     *         the block number by long value of the desired block.
     * @return the class {@link Block block} format wrapped into ApiMsg.
     * You can retrieve through the method {@link ApiMsg#getObject() getObject}.
     */
     ...
     * @param blockHash
     *         32 bytes hash of the desired block wrapped into the class {@link Hash256 Hash256}.
     * @param index
     *         the transaction position by int value of the transaction been stored into the desired block.
     * @return the class {@link Transaction transaction} information wrapped into ApiMsg.
     * You can retrieve through the method {@link ApiMsg#getObject() getObject}.
     */
     ...
     * @param index
     *         the transaction position by int value of the transaction been stored into the desired block.
     * @return the class {@link Transaction transaction} wrapped into ApiMsg.
     * You can retrieve through the method {@link ApiMsg#getObject() getObject}.
     */
     ...
     * @param blockHash
     *         32 bytes hash of the desired block wrapped into the class {@link Hash256 Hash256}.
     * @return the transaction number of the block by int value wrapped into ApiMsg.
     * You can retrieve through the method {@link ApiMsg#getObject() getObject}.
     */
    ...
    /**
     * Retrieves the total transactions committed by a certain account address
     ...
     * @param blockNumber
     *         the block number by long value of the desired block.
     * @return the transaction number of the block by long value wrapped into ApiMsg.
     * You can retrieve through the method {@link ApiMsg#getObject() getObject}.
     */
    ApiMsg getTransactionCount(Address address, long blockNumber);

    /**
     * Retrieves the transaction given the transaction hash. Function will throw
     * if transaction is not found, or the transaction hash is improperly
     * formatted.
     *
     * @param transactionHash
     *         32 bytes hash of the desired transaction wrapped into the class {@link Hash256 Hash256}.
     * @return the class {@link Transaction Transaction} containing all
     * relevant information related to the transaction wrapped into ApiMsg.
     * You can retrieve through the method {@link ApiMsg#getObject() getObject}.
     */
