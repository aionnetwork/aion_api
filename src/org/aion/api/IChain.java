...
public interface IChain {
     ...
     * block number.
     *
     * @param address the class {@link NewAddress Address} of the desired account to get the balance
     *     of.
     ...
     */
    ApiMsg getNonce(NewAddress address);
     ...
     *     retrieve through the method {@link ApiMsg#getObject() getObject}.
     */
    ApiMsg getTransactionCount(NewAddress address, long blockNumber);
     ...
     *
     * @param address the class {@link NewAddress Address} of the desired address to get the storage
     *     from.
     ...
     *     wrapped into ApiMsg.
     */
    ApiMsg getStorageAt(NewAddress address, int position);
     ...
     *     wrapped into ApiMsg.
     */
    ApiMsg getStorageAt(NewAddress address, int position, long blockNumber);
