...
public interface IContractController {
     ...
     * deploy been allowed. if the contract consume energy more than this number. the deploy will
     * fail, Also the contract deployer will been charged all of the energy for trying to deploy
     * this contract.
     * @param nrgPrice the long value represent the unit price of the energy the contract deployer
     * want to pay. It effect the contract deploy response time by the current network environment.
     ...
     *
     * A multi-contract source, set key value pair when you want to deploy the contract "key" with
     ...
     **/
    ApiMsg createFromSource(String source, Address from, long nrgLimit, long nrgPrice,
        BigInteger value, List<ISolidityArg> params);
     ...
     **/
    ApiMsg createFromSource(String source, Address from, long nrgLimit, long nrgPrice,
        BigInteger value, Map<String, List<ISolidityArg>> params);
     ...
     * the contract been stored inside the contractController. the user could deploy same contract
     * multiple times. Therefore the return will be a list of the IContract.
     * @see IContractController#getContract
     **/
     ...
     * contract object will been store inside the Controller and user can retrieve it by given the
     * contract address.
     * @see IContractController#getContract
     **/
