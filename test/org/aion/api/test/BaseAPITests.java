...
public class BaseAPITests {
    ...
    public void TestGetMinerAccount() {
        ...
        NewAddress buff = apiMsg.getObject();
        assertNotNull(buff);
    ...
    public void TestGetBalance() {
        ...
        apiMsg = api.getChain().getBalance((NewAddress) accs.get(0));
        assertFalse(apiMsg.isError());
    ...
    public void TestGetTransactionByBlockNumberAndIndex2() {
        ...
        assertTrue(transaction.getNrgConsumed() > NRG_LIMIT_TX_MIN);
        assertEquals(transaction.getNrgPrice(), NRG_PRICE_MIN);
        assertEquals(transaction.getTo(), Utils.ZERO_ADDRESS());
    ...
    public void TestUnlockAccount() {
        ...
        NewAddress fakeAcc = Utils.ZERO_ADDRESS();
    ...
    @Test
    public void TestCallbyContract() {
        System.out.println("run TestCallbyContract.");
        ...
        assertNotNull(cr);
        assertNotNull(cr.getData());
        assertEquals(1L, (long) cr.getData().get(0));
    ...
    public void TestGetPeerCount() {
        System.out.println("run TestGetPeerCount.");

        connectAPI();

        ApiMsg apiMsg = api.getNet().getPeerCount();
        assertFalse(apiMsg.isError());
